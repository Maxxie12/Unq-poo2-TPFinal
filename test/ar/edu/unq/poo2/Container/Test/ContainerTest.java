...
public class ContainerTest {
	 ...
	 @Test
	    public void testContainerDry() {
	        ContainerDry containerDry = new ContainerDry(5.0, 10.0, 3.0, 150.0, 1, "Dry");
	        ...
	        assertEquals("Dry", containerDry.getTipoContainer());
	 ...
	 @Test
	    public void testContainerReefer() {
	        ...
	        ContainerReefer containerReefer = new ContainerReefer(5.0, 10.0, 3.0, 150.0, 1, "Reefer", 20.0);
	        ...
	        assertEquals("Reefer", containerReefer.getTipoContainer());
	 ...
	 @Test
	    public void testContainerTanque() {
	        ...
	        ContainerTanque containerTanque = new ContainerTanque(8.0, 12.0, 4.0, 300.0, 2, "Tanque");
	        ...
	        assertEquals("Tanque", containerTanque.getTipoContainer());
